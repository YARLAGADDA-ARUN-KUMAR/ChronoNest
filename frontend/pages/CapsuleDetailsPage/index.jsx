    ...
    return (
      <div>
        ...
        <div className="pt-32 text-lg text-center text-red-400">
          ...
          <button
            onClick={() => navigate(-1)}
            className="mt-4 underline text-cyan-300"
          >
            Back
          </button>
        </div>
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(
        `http://localhost:3000/api/capsules/${capsule._id}`,
        {
          method: "DELETE",
        ...
        <div className="w-full max-w-2xl mx-auto">
          <div className={cardClass}>
            <div className="mb-6">
              ...
              <div className="text-lg text-slate-200 mb-5">
                {capsule.description}
              </div>
            </div>
            {capsule.images?.length > 0 &&
              capsule.images.some((img) => img) && (
                <div className="mb-6">
